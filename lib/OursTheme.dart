...
const Color OursColorMainRed = Color(0xFFBE4749);
const Color OursColorStandOutRed = Color(0xFFE68E8F);
...
final BoxShadow normalShadow1 =
    BoxShadow(color: OursColorRedShadow, offset: Offset(0, 4), blurRadius: 46);
